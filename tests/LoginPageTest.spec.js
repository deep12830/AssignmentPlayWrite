...
test('TC_001: Validate Email Address / Login Id and Password field is visible on login page',async ({page})=>{
...
test('TC_002: Validate Login button is visible and clickable on login page',async ({page})=>{
...
test('TC_003: Validate user is unable to login with invalid credentials', async ({ page }) => {
   //launch the url
 await page.goto('https://www.testyou.in/Login.aspx');
...
test('TC_004: Validate validation message on login with empty loginid and password fields', async ({ page }) => {
 //launch the url
await page.goto('https://www.testyou.in/Login.aspx');
...
test('TC_005: Validate user is able login wth valid credentials', async ({ page }) => {
 //launch the url
await page.goto('https://www.testyou.in/Login.aspx');
await page.locator('#ctl00_CPHContainer_txtUserLogin').fill('lalitgarg2041@gmail.com');
...
test('TC_006: Validate user is navigated to forgot password page on clicking forgot password link', async ({ page }) => {
 await page.goto('https://www.testyou.in/Login.aspx');
...
test('TC_007: Validate user is message , userid field and submit button on Forgot password page', async ({ page }) => {
 await page.goto('https://www.testyou.in/Login.aspx');
 await page.getByRole('link', { name: 'Forgot Password ?' }).click();
// assertion for url change to forgot password
 await expect(page).toHaveURL('https://www.testyou.in/ForgetPassword.aspx');
...
test('TC_008: Validate validation message on clicking Submit button with empty userid fields on forgot password page', async ({ page }) => {
 await page.goto('https://www.testyou.in/Login.aspx');
 await page.getByRole('link', { name: 'Forgot Password ?' }).click();
// assertion for url change to forgot password
 await expect(page).toHaveURL('https://www.testyou.in/ForgetPassword.aspx');
...
test('TC_009: Validate validation message on clicking Submit button with invalid userid fields on forgot password page', async ({ page }) => {
  await page.goto('https://www.testyou.in/Login.aspx');
  await page.getByRole('link', { name: 'Forgot Password ?' }).click();
 // assertion for url change to forgot password
  await expect(page).toHaveURL('https://www.testyou.in/ForgetPassword.aspx');
...
test('TC_010: Validate Term and Conditions link is available on login page and user is able to click on it', async ({ page }) => {
  await page.goto('https://www.testyou.in/Login.aspx');
